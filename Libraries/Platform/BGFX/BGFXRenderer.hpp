...
class BGFXMaterialData : public MaterialRenderData
{
public:
};

class BGFXMeshData : public  MeshRenderData
{
public:
...
class BGFXTextureData : public TextureRenderData
{
public:
...
{
public:
  BGFXRenderer(OsHandle windowHandle, String& error);
...
{
  return new BGFXRenderer(windowHandle, error);
}
